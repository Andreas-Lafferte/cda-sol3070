...
Respuesta 1: $\ln xy$ → _Regla del producto_

<br>

**Problema 2:** Simplifica: $\ln(b^3)$

Respuesta 2: $3 \ln b$ → _Regla de la potencia_
...
1. La @fig-fun muestra el gráfico de la función $y = 4 + 3x^2$, cuya forma es la de una parabóla.
